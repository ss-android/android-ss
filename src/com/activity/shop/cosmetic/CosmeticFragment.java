 ...
 * @version create time：2013-8-26 上午10:25:02 declare:
 */
public class CosmeticFragment extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		view = (View) inflater.inflate(R.layout.fragment_shopping_cosmetic,
				null);
	...
	public void initWidget() {
		...
		lvLife = (ListView) view.findViewById(R.id.Lv_Cosmetic);
