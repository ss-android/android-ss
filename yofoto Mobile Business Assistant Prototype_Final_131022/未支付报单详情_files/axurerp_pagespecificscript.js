...
gv_vAlignTable['u36'] = 'center';gv_vAlignTable['u16'] = 'center';gv_vAlignTable['u29'] = 'center';gv_vAlignTable['u21'] = 'center';document.getElementById('u6_img').tabIndex = 0;
...
if (true) {
	...
	self.location.href=$axure.globalVariableProvider.getLinkUrl('报单查询（待付款报单）.html');
