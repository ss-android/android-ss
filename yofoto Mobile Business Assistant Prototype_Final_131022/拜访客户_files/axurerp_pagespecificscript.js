...
gv_vAlignTable['u16'] = 'center';gv_vAlignTable['u28'] = 'center';gv_vAlignTable['u30'] = 'center';document.getElementById('u6_img').tabIndex = 0;
HookHover('u6', false);
...
if (true) {
	...
	self.location.href=$axure.globalVariableProvider.getLinkUrl('日程提醒_1.html');
